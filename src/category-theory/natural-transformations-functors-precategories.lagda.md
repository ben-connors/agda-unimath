...
## Interchanging left and right whiskering

Modulo associativity, we can interchange the order of left and right whiskering.
...
module _
  ...
  interchange-right-left-whisker-natural-transformation-Precategory :
    ...
    (α : natural-transformation-Precategory C D F G)
    (I : functor-Precategory E' C) →
    comp-natural-transformation-Precategory E' E
      ( comp-functor-Precategory E' C E
        ( comp-functor-Precategory C D E H F)
        ( I))
      ( comp-functor-Precategory E' C E
        ( comp-functor-Precategory C D E H G)
        ( I))
      ( comp-functor-Precategory E' D E
        ( H)
        ( comp-functor-Precategory E' C D G I))
      ( associative-natural-transformation-comp-functor-Precategory E' C D E
        ( I)
        ( G)
        ( H))
      ( right-whisker-natural-transformation-Precategory C E E'
        ( comp-functor-Precategory C D E H F)
        ( comp-functor-Precategory C D E H G)
        ( left-whisker-natural-transformation-Precategory C D E F G H α) I) ＝
    comp-natural-transformation-Precategory E' E
      ( comp-functor-Precategory E' C E
        ( comp-functor-Precategory C D E H F)
        ( I))
      ...
      ( comp-functor-Precategory E' D E
        ( H)
        ( comp-functor-Precategory E' C D G I))
      ( left-whisker-natural-transformation-Precategory E' D E
        ( comp-functor-Precategory E' C D F I)
        ( comp-functor-Precategory E' C D G I)
        ( H)
        ( right-whisker-natural-transformation-Precategory C D E' F G
          ( α)
          ( I)))
      ( associative-natural-transformation-comp-functor-Precategory E' C D E
        ( I)
        ( F)
        ( H))
  interchange-right-left-whisker-natural-transformation-Precategory F G H α I =
    eq-htpy-hom-family-natural-transformation-Precategory E' E
      ( comp-functor-Precategory E' C E
        ( comp-functor-Precategory C D E H F)
        ( I))
      ( comp-functor-Precategory E' D E
      ...
      ( _)
      ( λ x →
        ( left-unit-law-comp-hom-Precategory E _) ∙
        ( inv (right-unit-law-comp-hom-Precategory E _)))
```
